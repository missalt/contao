...
class __TwigTemplate_39b3eb247b000e1079f1579cfc6f93f4 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        if (        $this->unwrap()->hasBlock("matter", $context, $blocks)) {
            ...
            // line 134
            yield "                                    ";
            if ( !Twig\Extension\CoreExtension::testEmpty(Twig\Extension\CoreExtension::trim(($context["_block"] ?? null)))) {
                // line 135
                yield "                                        <h2>";
