...
class Contao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainer extends Container
{
    ...
    protected function getAssets_PackagesService()
    {
        ...
        $d = new \Symfony\Component\Asset\PathPackage('assets/ace', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.35.2', '%s?v=%s'), $c);
    ...
    protected function getContao_DataCollectorService()
    {
        ...
        $this->privates['contao.data_collector'] = $instance = new \Contao\CoreBundle\DataCollector\ContaoDataCollector($a, false, \dirname(__DIR__, 4), false, '.html');
    ...
    protected function getContao_Routing_RouteProviderService()
    {
        ...
        return $this->privates['contao.routing.route_provider'] = new \Contao\CoreBundle\Routing\RouteProvider($a, new \Contao\CoreBundle\Routing\Candidates\PageCandidates($b, $c), $c, false, false);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.packages' => [
                ...
                'contao/calendar-bundle' => '4.13.45',
                'contao/comments-bundle' => '4.13.45',
                'contao/conflicts' => 'dev-main',
                'contao/contao-demo' => '4.13',
                'contao/core-bundle' => '4.13.45',
                'contao/faq-bundle' => '4.13.45',
                'contao/image' => '1.2.1',
                'contao/imagine-svg' => '1.0.3',
                'contao/installation-bundle' => '4.13.45',
                'contao/listing-bundle' => '4.13.45',
                'contao/manager-bundle' => '4.13.45',
                'contao/manager-plugin' => '2.13.2',
                'contao/news-bundle' => '4.13.45',
                'contao/newsletter-bundle' => '4.13.45',
                'dasprid/enum' => '1.0.5',
                ...
                'symfony/clock' => '7.1.1',
                'symfony/config' => '5.4.40',
                'symfony/console' => '5.4.41',
                'symfony/debug-bundle' => '5.4.40',
                'symfony/dependency-injection' => '5.4.40',
                'symfony/deprecation-contracts' => '3.5.0',
                'symfony/doctrine-bridge' => '5.4.41',
                'symfony/dom-crawler' => '5.4.40',
                'symfony/dotenv' => '5.4.40',
                'symfony/error-handler' => '5.4.41',
                'symfony/event-dispatcher' => '5.4.40',
                'symfony/event-dispatcher-contracts' => '3.5.0',
                'symfony/expression-language' => '5.4.40',
                'symfony/filesystem' => '5.4.41',
                'symfony/finder' => '5.4.40',
                'symfony/framework-bundle' => '5.4.41',
                'symfony/http-client' => '5.4.41',
                'symfony/http-client-contracts' => '2.5.3',
                'symfony/http-foundation' => '5.4.40',
                'symfony/http-kernel' => '5.4.41',
                'symfony/intl' => '5.4.40',
                'symfony/lock' => '5.4.40',
                'symfony/mailer' => '5.4.41',
                'symfony/mime' => '5.4.41',
                'symfony/monolog-bridge' => '5.4.40',
                'symfony/monolog-bundle' => '3.10.0',
                'symfony/options-resolver' => '5.4.40',
                'symfony/password-hasher' => '5.4.40',
                ...
                'symfony/routing' => '5.4.40',
                'symfony/security-bundle' => '5.4.41',
                'symfony/security-core' => '5.4.41',
                'symfony/security-csrf' => '5.4.40',
                'symfony/security-guard' => '5.4.40',
                'symfony/security-http' => '5.4.41',
                'symfony/service-contracts' => '2.5.3',
                'symfony/stopwatch' => '5.4.40',
                'symfony/string' => '5.4.41',
                'symfony/templating' => '6.4.8',
                'symfony/translation' => '5.4.40',
